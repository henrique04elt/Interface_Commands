## Desenvolvido por Henrique  Rosa ##
##                                 ##
##                                 ##
##                                 ##
...
class CommandInterface:
    def __init__(self, master):
        self.master = master
        master.title("BOE Command Interface by ELETROMIDIA - HR")
        ...
        self.code_text = tk.Text(self.code_frame, height=3, width=50, font=("Helvetica", 12), bg="#f0f0f0",
                                 relief="solid", borderwidth=1)  # Altura ajustada
        ...
        self.ack_text = tk.Text(self.ack_frame, height=3, width=50, font=("Helvetica", 12), bg="#f0f0f0",
                                relief="solid", borderwidth=1)  # Altura ajustada
        ...
        self.schedule_button.grid(row=0, column=0, columnspan=1, pady=10)  # Posição ajustada
